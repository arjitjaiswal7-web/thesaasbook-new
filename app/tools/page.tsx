  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
        ...
        <section className="mt-6 grid gap-8 rounded-[2rem] border border-slate-200/80 bg-white/90 p-8 shadow-sm shadow-slate-200/40 lg:grid-cols-[minmax(0,1fr)_22rem] lg:p-10">
          <div>
